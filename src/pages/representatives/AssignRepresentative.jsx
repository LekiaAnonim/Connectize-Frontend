...
const UserSearchInput = ({ username, setUsername }) => (
...
const UserList = ({ isLoading, filteredUsers }) => (
  <section className="">
...
const RepresentativesList = ({ filteredUsers }) => (
  ...
  return (
    <section>
      <section className="space-y-6">
        ...
        <RepresentativesList filteredUsers={filteredUsers} />
      </section>
    </section>
  );
}
