...
export default function UserProfile() {
  return (
    <main className="bg-background">
      ...
      <section className="mt-20 max-md:container flex flex-col items-start md:flex-row p-3 gap-3">
        <ProductSidebar />
        <section className="grid grid-cols-1 xl:grid-cols-3 md:px-2 xl:px-4 gap-3 py-2">
...
function ProductSidebar() {
  return (
    <section className="space-y-8 max-md:mb-4 md:max-w-[400px]">
      <section className="space-y-5 px-2">
        <h1 className="text-4xl md:text-[2rem] font-bold">
...
function StatsText({ text }) {
  return (
    <div className="bg-gray-200/80 py-2 px-3 rounded-full text-sm">
