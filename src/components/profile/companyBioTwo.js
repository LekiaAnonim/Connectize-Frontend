  ...
  return (
    <div style={{background:"#"}}>
        ...
        <div style={{marginLeft:"20%"}}>
            <div className='my-4'>
                <h4>Upload  a VALID document of your </h4>
                <h4>company</h4>
            ...
            <form>
                <div className='me-3 col-sm-6 col-md-6 py-2' style={{marginTop:"3%"}}>
                    ...
                    <div className='d-flex'>
                        <input type='text' className='form-control border-0 mt-3' list="datalistOptions" id="exampleDataList" style={{background:"#EEEEEE", height:"50px"}}  placeholder='eg VAT TVN'/>
                ...
                <div className='col-sm-6 col-md-6'>
                    ...
                    <input type='file' className='form-control border-0 mt-3' style={{background:"#EEEEEE",height:"200px"}} placeholder='Upload a file'/>
                </div>
