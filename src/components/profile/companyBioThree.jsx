  ...
  return (
    <div style={{background:"#"}}>
        ...
        <div style={{marginLeft:"20%"}}>
            <div className='my-4'>
                <h4>Help us with brief information about</h4>
                <h4>your company</h4>
            ...
            <form>
                <div className='col-sm-6 col-md-6 py-2'>
                    ...
                    <input type='text' className='form-control border-0 mt-3' style={{background:"#EEEEEE",height:"50px"}} placeholder='eg. the large company'/>   
                </div>

                <div className='col-sm-6 col-md-6'>
                    <label>Office Address</label><br/>
                    <input type='text' className='form-control border-0 mt-3' style={{background:"#EEEEEE",height:"50px"}} placeholder='123, Royal Block, Esternbig Abj'/>
                </div>
  
                <div className='me-3 col-sm-6 col-md-6 py-2'>
                    <label>Country</label><br/>
                    <div className='d-flex'>
                    <select name="nationality" className='form-control border-0 mt-3' style={{background:"#EEEEEE",height:"50px"}}>
                ...
                <div className='col-sm-6 col-md-6 py-2'>
                    ...
                    <div className='d-flex'>
                        <input type='text' className='form-control border-0 mt-3' list="datalistOptions" id="exampleDataList" style={{background:"#EEEEEE", height:"50px"}}  placeholder='select city'/>
                        <div style={{marginLeft:"-25px",marginTop:"5%"}}>
                            <ArrowDown  />
                        </div>
                    </div>
...
export default CompanyBioThree