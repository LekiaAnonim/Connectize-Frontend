  ...
  let Feed = (props) => {
    ...
    return (
      <div className="d-flex gap-2 p-2 rounded" style={bg}>
        ...
        <Link to={link} className={textColor}>
          {text}
        </Link>
      </div>
    );
  ...
  return (
    <div>
      <div className="bg-white rounded p-3">
        ...
        <div>
          <Company img="images/icondell.PNG" name="Jenny Wilson" />
        </div>
        <div>
          <Company img="images/iconhuawei.PNG" name="Albert Flores" />
        </div>
        <div>
          <Company img="images/iconcooper.PNG" name="Basie Cooper" />
        </div>
        <div>
          <Company img="images/icondalene.PNG" name="Darlene Robertson" />
        </div>
        <div>
          <Company img="images/iconnorth.PNG" name="Esther Howard" />
        </div>
        <div>
          <Company img="images/iconnasa.PNG" name="Annette Black" />
        </div>
        <div>
          <Company img="images/icondell.PNG" name="Jenny Wilson" />
        </div>
        <div>
          <Company img="images/iconcody.PNG" name="Cody Fisher" />
        </div>
        <div>
          <Company img="images/iconnasa.PNG" name="Annette Black" />
        </div>
