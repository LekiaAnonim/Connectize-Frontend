...
import { Home, Message,Chartbar,Building,
        ...
        <Navbar expand="lg" className="bg-body-white">
            <Container>
                ...
                <Nav className="ms-5">
                    ...
                    <Nav.Link href="/chat" className='me-5 fw-bold'><Message /></Nav.Link>
                ...
                <Nav className='ms-5 fw-bold'>
                    <Nav.Link href="#about"><FeedsModal/></Nav.Link>
                    <Nav.Link href="/analysis"><Chartbar/></Nav.Link>
                    <Nav.Link href="/market"><Building/></Nav.Link>
                    <Nav.Link href="/organization"><Usergroup/></Nav.Link>
